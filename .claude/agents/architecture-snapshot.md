...
description: Generate compact intended-architecture docs for the repo from a 1-2 query CodeGraph observation. Use for first-time setup or periodic snapshot, not per feature.
